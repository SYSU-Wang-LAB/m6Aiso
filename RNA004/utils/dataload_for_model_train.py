...
def multi_Train_data_load(pos_signal_filename,neg_signal_filename,label_filename):
...
if __name__ == "__main__":
	import sys
	dataloader,train_id2sitename_dict = multi_Train_data_load(
		pos_signal_filename="/home/ZJRen/pytorch/semi_suprevise_model/bin/test/dora_positive.DRACH.sequence.gz",
		neg_signal_filename="/home/ZJRen/pytorch/semi_suprevise_model/bin/test/dora_negative.DRACH.sequence.gz",
		label_filename="/home/ZJRen/pytorch/semi_suprevise_model/bin/test/dora_DRACH_label.txt.gz"
		)
